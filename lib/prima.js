...
const getThings = async(MongoClient, things) => {
...
//// PRODUCTS
export const getProducts = async (MongoClient) => {
  return await getThings(MongoClient, 'products')
}

//// SOURCES
export const getSources = async (MongoClient) => {
  return await getThings(MongoClient, 'sources')
}

//// CARTS
export const getCart = async (MongoClient) => {
  // debugger
  const db = await getDb(MongoClient)()
